...
class ChatOpenAI(BaseChatModel):
    ...
    def bind_functions(
        ...
        **kwargs: Any,
        ...
        # NOTE: bind_functions调用了convert_to_openai_function，将function转换为json的格式
        ...
        # NOTE: 可以看出来bind_functions和bind_tools传递给bind的关键字是不一样的，bind_functions传的是functions
        return super().bind(
    ...
    def bind_tools(
        ...
        **kwargs: Any,
        ...
        # NOTE: bind_tools的时候试用了convert_to_openai_tool处理工具， 将tool转换为json格式
        ...
        # NOTE: bind_tools主要是多了一个convert_to_openai_tool的过程，之后还是会调用bind函数完成tool的绑定
