...
# NOTE: 通过这个函数初始化agent，这个agent是会使用工具哒
def initialize_agent(
    ...
    **kwargs: Any,
    ...
    if agent is not None:
        ...
        # NOTE: 完成一个映射，依据AgentType去找对应的Agent类
        # (如果是ZERO_SHOT_REACT_DESCRIPTION->langchain.agent.mrkl.base找ZeroShotAgent)
        agent_cls = AGENT_TO_CLASS[agent]
        agent_kwargs = agent_kwargs or {} # 可以为空
        # NOTE: 这儿返回的只是一个将LLM，tool封装在一起的ZeroShotAgent类(Agent的子类，mkrl.base)
